...
import WeightLossDoc from "./WeightLossDoc";
...
const WeightLoss = () => {
    ...
    const submitHandler = async (e) => {
        ...
        const data = {
            ...
            consentType: "medication-assisted-weight-loss",
        ...
        forms: [
            {
                ...
                name: "Read Consent",
                component: (
                    <PdfPreview key={7} Doc={<WeightLossDoc showToolbar={false} />} />
                ),
            },
            {
                id: 2,
            ...
            },
            {
                ...
                name: "Preview & Submit",
                component: (
                    <PdfPreview key={7} Doc={<WeightLossDoc formData={formData} />} />
                ),
            },
        ],
    };

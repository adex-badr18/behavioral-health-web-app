...
import CommunityHousingDoc from "./CommunityHousingDoc";
...
const CommunityHousing = () => {
    ...
    const submitHandler = async (e) => {
        ...
        const pdfBlob = await pdf(
            <CommunityHousingDoc formData={formData} />
        ).toBlob();
        const pdfFile = new File(
            [pdfBlob],
            `community-housing-consent-${formData.basicInfo.patientId}.pdf`,
            {
        ...
        forms: [
            {
                ...
                component: (
                    <PdfPreview
                        key={7}
                        Doc={<CommunityHousingDoc showToolbar={false} />}
                        title="Community Housing Consent Preview"
                    />
                ),
            },
            {
            ...
            },
            {
                ...
                component: (
                    <PdfPreview
                        ...
                        title="Completed Community Housing Consent"
                    />
                ),
            },
        ],

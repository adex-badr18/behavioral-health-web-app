...
import OutpatientDoc from "./OutpatientDoc";
import OutpatientForm from "./OutpatientForm";

const Outpatient = ({ title, consentType }) => {
    const { id } = useParams();
    ...
    const submitHandler = async (e) => {
        ...
        const pdfBlob = await pdf(<OutpatientDoc formData={formData} />).toBlob();
        ...
        forms: [
            {
                ...
                component: (
                    <PdfPreview
                        key={7}
                        Doc={
                            <OutpatientDoc title={title} showToolbar={false} />
                        }
                    />
                ),
            },
            ...
            },
            {
                ...
                component: (
                    <PdfPreview
                        key={7}
                        Doc={
                            <OutpatientDoc formData={formData} title={title} />
                        }
                    />
                ),
            },

...
import EarlyInterventionForm from "./EarlyInterventionForm";
import EarlyInterventionDoc from "./EarlyInterventionDoc";
...
const EarlyIntervention = () => {
    ...
    const submitHandler = async (e) => {
        ...
        const data = {
            ...
            consentType: "asam-0.5-early-intervention",
        ...
        forms: [
            {
                ...
                name: "Read Consent",
                component: (
                    <PdfPreview key={7} Doc={<EarlyInterventionDoc showToolbar={false} />} />
                ),
            },
            {
                id: 2,
            ...
            },
            {
                ...
                name: "Preview & Submit",
                component: (
                    <PdfPreview key={7} Doc={<EarlyInterventionDoc formData={formData} />} />
                ),
            },
        ],
    };

...
import OmhcDoc from "./OmhcDoc";
import PdfPreview from "../../../../../components/PdfPreview";
import { convertToISO } from "../../../../admin/utils";
import OmhcForm from "./OmhcForm";
...
const Omhc = () => {
    ...
    }, [formData.data.acceptanceChoice, formData.data.who]);
    ...
    const submitHandler = async (e) => {
        ...
        const pdfBlob = await pdf(<OmhcDoc formData={formData} />).toBlob();
        const pdfFile = new File([pdfBlob], `omhc-consent-${formData.basicInfo.patientId}.pdf`, {
    ...
    const formSteps = {
        ...
        forms: [
            ...
            },
            {
                ...
                name: "Preview & Submit",
                component: (
                    <PdfPreview key={7} Doc={<OmhcDoc formData={formData} />} />
                ),
            },
        ],
    };
